class Analytics {
  ...
  Analytics({
    ...
    required this.quizAccuracyTrend,
  ...
  factory Analytics.fromJson(Map<String, dynamic> json) {
    return Analytics(
      wordBreakdown: (json['word_breakdown'] as List? ?? [])
          .map((e) => AnalyticsEntry.fromJson(e))
          .toList(),
      quizAccuracyTrend: (json['quiz_accuracy_trend'] as List? ?? [])
          .map((e) => QuizTrend.fromJson(e))
          .toList(),
      activityByHour: (json['activity_by_hour'] as List? ?? [])
          .map((e) => HourlyActivity.fromJson(e))
          .toList(),
      weeklyVelocity: (json['weekly_velocity'] as List? ?? [])
          .map((e) => WeeklyVelocity.fromJson(e))
          .toList(),
      contentDiversity: (json['content_diversity'] as List? ?? [])
          .map((e) => AnalyticsEntry.fromJson(e))
          .toList(),
    );
  }
