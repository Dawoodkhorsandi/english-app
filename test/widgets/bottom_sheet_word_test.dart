  ...
  group('WordBottomSheet', () {
    testWidgets('renders term', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(term: 'ubiquitous'),
      ));
    ...
    testWidgets('renders persian when provided', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(term: 'hello', persian: 'سلام'),
      ));
    ...
    testWidgets('renders meaning when provided', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(term: 'hello', meaning: 'A greeting'),
      ));
    ...
    testWidgets('renders dictionary button when onOpenDictionary provided', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(
          term: 'test',
          onOpenDictionary: SizedBox.new,
        ),
      ));
    ...
    testWidgets('does not render dictionary button when onOpenDictionary is null', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(term: 'test'),
      ));
    ...
    testWidgets('does not render optional fields when null', (tester) async {
      await tester.pumpWidget(wrapInApp(
        const WordBottomSheet(term: 'hello'),
      ));
